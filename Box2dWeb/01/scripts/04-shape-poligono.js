window.onload = function () {
    ...
    function criarCorpoPoligono()
    {
        var corpoDef = new b2BodyDef;
        corpoDef.type = b2Body.b2_dynamicBody;
        corpoDef.position.x = 230 / escala;
        corpoDef.position.y = 50 / escala;
        ...
        // pontos definidos no sentido horário
        // influência no na detecção de colisão
        var points = [
            new b2Vec2(0, 0),
            new b2Vec2(40 / escala, 50 / escala),
            new b2Vec2(50 / escala, 100 / escala),
            new b2Vec2(-50 / escala, 100/ escala),
            new b2Vec2(-40 / escala, 50 / escala)
        ];
